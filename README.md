...
The included plotting logic generates a "Time Cliff" graph. By sampling distances from just above Sagittarius a* event horizo (~12.7M km) out to 100M km, the graph visualizes the dramatic drop in proper time as an observer approaches the black hole's edge.
